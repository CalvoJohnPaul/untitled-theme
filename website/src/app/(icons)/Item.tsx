...
export function Item() {
	...
	return (
		<Dialog.Root lazyMount unmountOnExit>
			<Dialog.Trigger className="flex aspect-square icon:size-8 cursor-pointer items-center justify-center rounded border border-neutral-300 icon:stroke-[1.66667] p-2 hover:bg-neutral-50 dark:border-neutral-800 dark:hover:bg-neutral-800/10">
				<span
